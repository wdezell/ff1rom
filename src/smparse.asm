...
SMPB1AD:.DW     SMPB1       ; POINTER - ADDRESS OF COMPONENT PARSING BUFFER 1
SMPB2AD:.DW     SMPB2       ; POINTER - ADDRESS OF COMPONENT PARSING BUFFER 2
SMPB3AD:.DW     SMPB3       ; POINTER - ADDRESS OF COMPONENT PARSING BUFFER 3
SMPB4AD:.DW     SMPB4       ; POINTER - ADDRESS OF COMPONENT PARSING BUFFER 4
SMPB5AD:.DW     SMPB5       ; POINTER - ADDRESS OF COMPONENT PARSING BUFFER 5
