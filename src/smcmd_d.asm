        ...
        ;; FORMAT:  D <START> <END>
        ;;
        ;;   THE DUMP MEMORY COMMAND OUTPUTS A TABULAR DISPLAY OF THE CONTENTS OF MEMORY
        ...
        ;;
        ;;   THE DUMP MEMORY COMMAND ACCEPTS ZERO, ONE, OR TWO ADDRESS PARAMETERS.  IF
        ...
        ;;   STARTING AT THE SPECIFIED LOCATION. TYPING 'D' WITH NO PARAMETERS WILL DISPLAY
        ;;   THE NEXT 256-BYTE BLOCK OF MEMORY STARTING AT THE ADDRESS FOLLOWING THE LAST
        ;;   DISPLAYED BYTE. ONCE AN DUMP COMMAND HAS BEEN EXECUTED, PRESSING 'ENTER'
        ;;   BY ITSELF WILL BE INTERPRETED THE SAME AS 'D' WITH NO PARAMETERS.
        ;;
        ;; --------------------------------------------------------------------------------
...
SMCMDD: .EQU    $
        ...
        JP      NC,_SMESYN  ; NO
        LD      E,0         ; ENSURE ROW ALWAYS STARTS MODULO 16
        ...
        ;CALL    _SMDSEA     ; CALL ROUTINE TO SAVE / ADJUST ENDING ADDRESS
        ...
        LD      A,B         ; LENGTH RETURNED AS BC PAIR, ENSURE BOTH REGS ARE 0
        OR      C           ;
        JP      NZ,_SMESYN  ; NON-BLANK - REPORT SYNTAX ERROR
        ...
        JP      Z,_SMEROS   ; ERROR IF BOTH ARE THE SAME (NO RANGE)
    ...
    ;;   HANDLES 'D' WITH ONE OR ZERO ADDRESS PARAMETERS
...
_SMDISP:CALL    PRINL
        ...
        ; DISPLAY LINE HEADER - PRINT ADDRESS
_SMDLH: CALL    PRINL               ; INDENT
        .TEXT   "  ",NULL
        ...
        ; DISPLAY LINE DATA - PRINT HEX REPRESENTATION OF 16 DATA BYTES BEGINNING AT CURRENT ADDRESS
        LD      B,16
        LD      HL,(SMCURA)
_SMDLD: CALL    BY2HXA              ; CONVERT BYTE VALUE TO PRINTABLE 2-CHAR HEX VALUE IN REG PAIR DE
        ...
        ; DISPLAY LINE ASCII REPRESENTATIONS
        ...
        ; END LOOP WHEN CURRENT ADDRESS = END ADDRESS OR END OF MEMORY
        LD      A,H         ; DID THE LAST INC CAUSE HL TO WRAP AROUND TO 0000H?
        OR      L
        JP      Z,_SMDFN    ; YES - UPDATE STARTING ADDRESS AND BAIL
